<%@ Page Title="" Language="C#" MasterPageFile="~/Adminn/Admin.master" AutoEventWireup="true" CodeFile="updateCategory.aspx.cs" Inherits="Adminn_updateCategory" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button
                                        ...
                                        Text="Submit"
                                        OnClick="updateCategoryBtn_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
